...
- ### Bug Catcher Sammy
  ...
  - <Pokemon name="Weedle" />: <PokeMove name="Tail Whip" /> x1-2, <PokeMove name="Tackle" /> x4-6
    ...
    - <PokeDamage
        name="Poison Sting"
        defender={{ name: 'squirtle', level: 6, ev: 0 }}
        attacker={{ name: 'weedle', level: 9, atk: 11 }}
      />
    - **Poison** damage:
      <StateContext>
        {({ starter }) => (
...
- ### Camper Liam
  ...
  - <Pokemon name="Sandshrew" />: <PokeMove name="Bubble" torrent={true} /> x2-4
    ...
    - <PokeDamage
        name="Scratch"
        defender={{ name: 'squirtle', level: 9, ev: 1 }}
        attacker={{ name: 'sandshrew', level: 11, atk: 21 }}
      />
...
- ### Leader Brock
  ...
  - <Pokemon name="Geodude" />: <PokeMove name="Bubble" torrent={true} /> (x2)
    ...
    - <PokeDamage
        name="Tackle"
        defender={{ name: 'squirtle', level: 10, ev: 2 }}
        attacker={{ name: 'geodude', level: 12, atk: 24 }}
      />
    - <PokeDamage
        name="Tackle"
        defender={{ name: 'squirtle', level: 10, ev: 2, stage: 1 }}
        attacker={{ name: 'geodude', level: 12, atk: 24 }}
      />
  ...
  - <Pokemon name="Onix" />: <PokeMove name="Bubble" torrent={true} /> (x2)
    ...
    - <PokeDamage
        name="Rock Tomb"
        defender={{ name: 'squirtle', level: 11, ev: 3 }}
        attacker={{ name: 'geodude', level: 14, atk: 17 }}
      />
    - <PokeDamage
        name="Tackle"
        defender={{ name: 'squirtle', level: 11, ev: 3 }}
    ...
    - <PokeDamage
        name="Rock Tomb"
        defender={{ name: 'squirtle', level: 11, ev: 3, stage: 1 }}
        attacker={{ name: 'geodude', level: 14, atk: 17 }}
      />
    - <PokeDamage
        name="Tackle"
...
- Fight **ONE** of the following optional trainers for EXP depending on the situation
  ...
  - ### Youngster Josh (if Torrent at level 15 and want to keep torrent)
    ...
    - <Pokemon name="Rattata" />: <PokeMove name="Water Gun" torrent={true} />
      ...
      - <PokeDamage
          name="Quick Attack"
          defender={{ name: 'squirtle', level: 15, ev: 10 }}
          attacker={{ name: 'rattata', level: 10, atk: 14 }}
        />
    ...
    - <Pokemon name="Rattata" />: <PokeMove name="Water Gun" torrent={true} />
      ...
      - <PokeDamage
          name="Quick Attack"
          defender={{ name: 'squirtle', level: 15, ev: 10 }}
          attacker={{ name: 'rattata', level: 10, atk: 16 }}
        />
  ...
  - ### Rocket Spinner (if you can take a hit from Hyper Fang)
    ...
    - <Pokemon name="Rattata" />: <PokeMove
      ...
      - <PokeDamage
          name="Hyper Fang"
          defender={{ name: 'squirtle', level: 15, ev: 10 }}
          attacker={{ name: 'rattata', level: 13, atk: 19 }}
        />
...
- ### Leader Misty
  ...
  - <Pokemon name="Starmie" />: <PokeMove name="Bite" />, (<PokeMove name="Tackle" />
    ...
    - <PokeDamage
        name="Swift"
        defender={{ name: 'wartortle', level: 20, ev: 11 }}
        attacker={{ name: 'starmie', level: 21, atk: 39 }}
      />

    - <PokeDamage
        name="Water Pulse"
        defender={{ name: 'wartortle', level: 20, ev: 0 }}
        attacker={{ name: 'starmie', level: 21, atk: 47 }}
      />
...
- ### Rival
  ...
  - <Pokemon name="Pidgeotto" />: <PokeMove name="Water Pulse" />, <PokeMove name="Bite" />
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 21, ev: 13 }}
        attacker={{ name: 'pidgeotto', level: 17, atk: 26 }}
        adjustEV={adjustEV}
      />
  ...
  - <StateContext>
    ...
    - <PokeDamage
        name="Vine Whip"
        defender={{ name: 'wartortle', level: 21, ev: 0 }}
        attacker={{ name: 'bulbasaur', level: 18, atk: 30 }}
      />
  ...
  - <Pokemon name="Rattata" />: <PokeMove name="Water Pulse" />
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 22, ev: 13 }}
        attacker={{ name: 'rattata', level: 15, atk: 24 }}
        adjustEV={adjustEV}
      />
...
- ### Lass Haley
  ...
  - <Pokemon name="Pidgey" />: <PokeMove name="Bite" />
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 25, ev: 19 }}
        attacker={{ name: 'pidgey', level: 13, atk: 16 }}
      />
...
- ### Rocket Grunt
  ...
  - <Pokemon name="Drowzee" />: <PokeMove name="Mega Kick" />
    ...
    - <PokeDamage
        name="Headbutt"
        defender={{ name: 'wartortle', level: 25, ev: 19 }}
        attacker={{ name: 'drowzee', level: 17, atk: 23 }}
      />
    - <PokeDamage
        name="Confusion"
        defender={{ name: 'wartortle', level: 25, ev: 0 }}
        attacker={{ name: 'drowzee', level: 17, atk: 19 }}
      />
...
- ### Camper Jeff
  ...
  - <Pokemon name="Raticate" />: <PokeMove
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 25, ev: 19 }}
        attacker={{ name: 'raticate', level: 16, atk: 30 }}
      />
...
- ### Rival
  ...
  - <Pokemon name="Pidgeotto" />: <PokeMove
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 26, ev: 19 }}
        attacker={{ name: 'pidgeotto', level: 19, atk: 28 }}
        displayLevel={true}
        adjustEV={adjustEV}
      />
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 27, ev: 19 }}
        attacker={{ name: 'pidgeotto', level: 19, atk: 28 }}
        displayLevel={true}
        adjustEV={adjustEV}
      />
  ...
  - <StateContext>
    ...
    - <PokeDamage
        name="Vine Whip"
        defender={{ name: 'wartortle', level: 26, ev: 1 }}
        attacker={{ name: 'ivysaur', level: 20, atk: 39 }}
        displayLevel={true}
      />
    - <PokeDamage
        name="Vine Whip"
        defender={{ name: 'wartortle', level: 27, ev: 1 }}
        attacker={{ name: 'ivysaur', level: 20, atk: 39 }}
        displayLevel={true}
      />
  ...
  - <Pokemon name="Raticate" />: <PokeMove
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 26, ev: 19 }}
        attacker={{ name: 'raticate', level: 16, atk: 28 }}
        displayLevel={true}
        adjustEV={adjustEV}
      />
    - <PokeDamage
  ...
  - <Pokemon name="Kadabra" />: <PokeMove name="Bite" />
    ...
    - <PokeDamage
        name="Confusion"
        defender={{ name: 'wartortle', level: 26, ev: 2 }}
        attacker={{ name: 'kadabra', level: 18, atk: 49 }}
        displayLevel={true}
      />
    - <PokeDamage
        name="Confusion"
        defender={{ name: 'wartortle', level: 27, ev: 2 }}
        attacker={{ name: 'kadabra', level: 18, atk: 49 }}
        displayLevel={true}
      />
...
- ### Leader Surge
  ...
  - <Pokemon name="Raichu" />: <PokeMove name="Water Pulse" />, <PokeMove
    ...
    - <PokeDamage
        name="Shock Wave"
        defender={{ name: 'wartortle', level: 28, ev: 2 }}
        attacker={{ name: 'raichu', level: 24, atk: 52 }}
      />
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 28, ev: 19 }}
        attacker={{ name: 'raichu', level: 24, atk: 43 }}
        adjustEV={adjustEV}
      />
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 28, ev: 19, stage: -2 }}
        attacker={{ name: 'raichu', level: 24, atk: 43 }}
        adjustEV={adjustEV}
      />
...
- Walk along the green path. Fight yellow trainers and **avoid red trainers**.
  ...
  ![Rock Tunnel Map 2](../../static/img/frlg/RockTunnel-2.png)
...
- ### Jr Trainer Martha
  ...
  - <Pokemon name="Bulbasaur" />: <PokeMove name="Mega Kick" />
    ...
    - <PokeDamage
        name="Razor Leaf"
        defender={{ name: 'wartortle', level: 30, ev: 3 }}
        attacker={{ name: 'bulbasaur', level: 22, atk: 33 }}
      />
...
- ## Rocket Grunt
  ...
  - <Pokemon name="Raticate" />: <PokeMove
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'wartortle', level: 32, ev: 28 }}
        attacker={{ name: 'raticate', level: 20, atk: 37 }}
      />
...
- ### Giovanni
  ...
  - <Pokemon name="Kangaskhan" />: <PokeMove name="Water Pulse" /> x2-3
    ...
    - <PokeDamage
        name="Mega Punch"
        defender={{ name: 'blastoise', level: 36, ev: 35 }}
        attacker={{ name: 'kangaskhan', level: 29, atk: 68 }}
        adjustEV={adjustEV}
      />
    - <PokeDamage
        name="Mega Punch"
        defender={{ name: 'blastoise', level: 36, ev: 35, stage: -1 }}
        attacker={{ name: 'kangaskhan', level: 29, atk: 68 }}
        adjustEV={adjustEV}
      />
  ...
  - #### X Attack Strategy
    ...
    - <Pokemon name="Pidgeotto" />: <PokeItem name="Guard Spec" />, <PokeItem name="X Accuracy" />
      ...
      - <PokeDamage
          name="Quick Attack"
          defender={{ name: 'blastoise', level: 36, ev: 35 }}
          attacker={{ name: 'pidgeotto', level: 25, atk: 38 }}
        />
    ...
    - <Pokemon name="Ivysaur" />: <PokeMove name="Mega Kick" />
      ...
      - <PokeDamage
          name="Razor Leaf"
          defender={{ name: 'blastoise', level: 36, ev: 3 }}
          attacker={{ name: 'ivysaur', level: 25, atk: 48 }}
        />
      - <PokeDamage
          name="Razor Leaf"
          defender={{ name: 'blastoise', level: 36, ev: 3 }}
          attacker={{ name: 'ivysaur', level: 25, atk: 48, torrent: true }}
        />
    ...
    - <Pokemon name="Gyarados" />: <PokeMove name="Mega Kick" />
      ...
      - <PokeDamage
          name="Thrash"
          defender={{ name: 'blastoise', level: 37, ev: 35 }}
          attacker={{ name: 'gyarados', level: 23, atk: 65 }}
        />
...
- ### Ghost Marowak
  ...
  - <Pokemon name="Marowak" />: <PokeMove name="Water Pulse" torrent={true} />
    ...
    - <PokeDamage
        name="Bonemerang"
        defender={{ name: 'blastoise', level: 36, ev: 35 }}
        attacker={{ name: 'marowak', level: 30, atk: 62 }}
        adjustEV={adjustEV}
      />
...
- ### Rocket Grunt
  ...
  - <Pokemon name="Raticate" />: <PokeMove name="Water Gun" torrent={true} /> / <PokeMove name="Water Pulse" />
    ...
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'blastoise', level: 38, ev: 38 }}
        attacker={{ name: 'raticate', level: 23, atk: 46 }}
      />
...
- ### Leader Koga
  ...
  - <Pokemon name="Muk" />: <PokeMove name="Surf" torrent={true} />, (<PokeItem
    ...
    - <PokeDamage
        name="Sludge"
        defender={{ name: 'blastoise', level: 41, ev: 39 }}
        attacker={{ name: 'muk', level: 39, atk: 77 }}
      />
  ...
  - <Pokemon name="Weezing" />: <PokeMove name="Surf" torrent={true} /> (at +1)
    ...
    - <PokeDamage
        name="Sludge"
        defender={{ name: 'blastoise', level: 42, ev: 40 }}
        attacker={{ name: 'weezing', level: 43, atk: 82 }}
        adjustEV={adjustEV}
      />
...
- ### Leader Blaine
  ...
  - <StateContext>
    ...
    - <PokeDamage
        name="Take Down"
        defender={{ name: 'blastoise', level: 42, ev: 42, defBadge: true }}
        attacker={{ name: 'growlithe', level: 42, atk: 63 }}
      />
    - <PokeDamage
        name="Fire Blast"
        defender={{ name: 'blastoise', level: 42, ev: 8 }}
        attacker={{ name: 'growlithe', level: 42, atk: 63 }}
      />
  ...
  - <Pokemon name="Rapidash" />: <PokeMove name="Surf" />
    ...
    - <PokeDamage
        name="Bounce"
        defender={{ name: 'blastoise', level: 42, ev: 42, defBadge: true }}
        attacker={{ name: 'rapidash', level: 42, atk: 80 }}
      />
    - <PokeDamage
        name="Fire Blast"
        defender={{ name: 'blastoise', level: 42, ev: 8 }}
        attacker={{ name: 'rapidash', level: 42, atk: 72 }}
      />
...
- ### Leader Erika
  ...
  - <Pokemon name="Vileplume" />: <PokeMove name="Blizzard" />
    ...
    - <PokeDamage
        name="Giga Drain"
        defender={{ name: 'blastoise', level: 44, ev: 8, defBadge: true }}
        attacker={{ name: 'vileplume', level: 29, atk: 63 }}
      />
...
- ### Rival
  ...
  - <Pokemon name="Pidgeot" />: <PokeItem
    ...
    - <PokeDamage
        name="Wing Attack"
        defender={{ name: 'blastoise', level: 44, ev: 44, defBadge: true }}
        attacker={{ name: 'pidgeot', level: 37, atk: 68 }}
      />
    - <PokeDamage
        name="Quick Attack"
        defender={{ name: 'blastoise', level: 44, ev: 44, defBadge: true }}
...
- ### Giovanni
  ...
  - <Pokemon name="Kangaskhan" />: <PokeMove name="Surf" torrent={true} />
    ...
    - <PokeDamage
        name="Fake Out"
        defender={{ name: 'blastoise', level: 46, ev: 47, defBadge: true }}
        attacker={{ name: 'kangaskhan', level: 35, atk: 82 }}
      />
    - <PokeDamage
        name="Mega Punch"
        defender={{ name: 'blastoise', level: 46, ev: 47, defBadge: true }}
...
- ### Leader Sabrina
  ...
  - <StateContext>
    ...
    - <PokeDamage
        name="Psybeam"
        defender={{ name: 'blastoise', level: 47, ev: 12, defBadge: true }}
        attacker={{ name: 'venomoth', level: 38, atk: 65 }}
      />
...
- ### Rival
  ...
  - <Pokemon name="Venusaur" />: <PokeMove name="Blizzard" />
    ...
    - <PokeDamage
        name="Razor Leaf"
        defender={{ name: 'blastoise', level: 49, ev: 12, defBadge: true }}
        attacker={{ name: 'venusaur', level: 53, atk: 126 }}
      />
  ...
  - <Pokemon name="Alakazam" />: <PokeMove name="Surf" />
    ...
    - <PokeDamage
        name="Psychic"
        defender={{ name: 'blastoise', level: 50, ev: 13, defBadge: true }}
        attacker={{ name: 'alakazam', level: 47, atk: 140 }}
      />
...
- ### Lorelei
  ...
  - <Pokemon name="Lapras" />: <PokeMove name="Bite" /> x3
    ...
    - <PokeDamage
        name="Body Slam"
        defender={{ name: 'blastoise', level: 52, ev: 60, defBadge: true }}
        attacker={{ name: 'lapras', level: 54, atk: 113 }}
        adjustEV={adjustEV}
      />
  ...
  - #### High HP Strategy
    ...
    - <Pokemon name="Onix" />: <PokeItem
      ...
      - <PokeDamage
          name="Rock Tomb"
          defender={{ name: 'blastoise', level: 52, ev: 60, defBadge: true }}
          attacker={{ name: 'onix', level: 51, atk: 66 }}
          adjustEV={adjustEV}
        />
      - <PokeDamage
          name="Earthquake"
    ...
    - <Pokemon name="Hitmonchan" />: <PokeMove name="Surf" />
      ...
      - <PokeDamage
          name="Mach Punch"
          defender={{ name: 'blastoise', level: 52, ev: 61, defBadge: true }}
          attacker={{ name: 'hitmonchan', level: 53, atk: 132 }}
          adjustEV={adjustEV}
        />
      - <PokeDamage
          name="Sky Uppercut"
...
- ### Agatha
  ...
  - <Pokemon name="Gengar" />: <PokeItem name="X Speed" />, <PokeItem
    ...
    - <PokeDamage
        name="Shadow Punch"
        defender={{ name: 'blastoise', level: 53, ev: 62, defBadge: true }}
        attacker={{ name: 'gengar', level: 54, atk: 100 }}
        adjustEV={adjustEV}
      />
...
- ### Lance
  ...
  - #### Safe strategy
    ...
    - <Pokemon name="Gyarados" />: <PokeMove name="Bite" />, <PokeItem name="X Accuracy" />
      ...
      - <PokeDamage
          name="Hyper Beam"
          defender={{ name: 'blastoise', level: 54, ev: 62, defBadge: true }}
          attacker={{ name: 'gyarados', level: 56, atk: 161 }}
        />
    ...
    - <Pokemon name="Dragonair" />: <PokeMove name="Blizzard" />
      ...
      - <PokeDamage
          name="Hyper Beam"
          defender={{ name: 'blastoise', level: 54, ev: 62, defBadge: true }}
          attacker={{ name: 'dragonair', level: 54, atk: 111 }}
        />
    ...
    - <Pokemon name="Aerodactyl" />: <PokeMove name="Surf" />
      ...
      - <PokeDamage
          name="Hyper Beam"
          defender={{ name: 'blastoise', level: 55, ev: 62, defBadge: true }}
          attacker={{ name: 'aerodactyl', level: 58, atk: 129 }}
        />
...
- ### Champion
  ...
  - <Pokemon name="Pidgeot" />: <PokeItem name="Guard Spec" />, <PokeItem name="X Speed" />
    ...
    - <PokeDamage
        name="Aerial Ace"
        defender={{ name: 'blastoise', level: 55, ev: 62, defBadge: true }}
        attacker={{ name: 'pidgeot', level: 59, atk: 117 }}
      />
  ...
  - <Pokemon name="Gyarados" />: <PokeMove name="Bite" />, <PokeMove name="Blizzard" />
    ...
    - <PokeDamage
        name="Thrash"
        defender={{ name: 'blastoise', level: 56, ev: 64, defBadge: true }}
        attacker={{ name: 'gyarados', level: 59, atk: 153 }}
      />
  ...
  - <Pokemon name="Arcanine" />: <PokeMove name="Surf" />
    ...
    - <PokeDamage
        name="Extreme Speed"
        defender={{ name: 'blastoise', level: 56, ev: 64, defBadge: true }}
        attacker={{ name: 'arcanine', level: 61, atk: 158 }}
      />
