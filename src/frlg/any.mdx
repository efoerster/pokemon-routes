...
- Enter your Squirtle IVs: <StarterPicker />
...
- Kill any level 2 or 3 <Pokemon name="Pidgey" /> / <Pokemon name="Rattata" /> along the way.
  - Do not kill a level 3 <Pokemon name="Pidgey" /> if Modest or less than 21 Attack.
  - If 31 IV speed, attempt to kill an extra <Pokemon name="Pidgey" /> / <Pokemon name="Rattata" /> on Route 1.
...
- ### Bruno
  ...
  - #### Mid HP Strategy
    ...
    - <Pokemon name="Hitmonlee" />: <PokeMove name="Surf" />
      <SpeedHint range={{ from: 17, to: 18, at: 0 }} />
