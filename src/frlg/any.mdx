...
- ### Bug Catcher Sammy
  ...
  - <Pokemon name="Weedle" />: <PokeMove name="Tail Whip" /> x1-2, <PokeMove name="Tackle" /> x4-6
    ...
    - **Poison** damage:
      <StateContext stateKey="starter">
        {({ hp }) => <b> {hp <= 11 ? '2' : '2 at level 6, 3 at level 7'}</b>}
      </StateContext>
